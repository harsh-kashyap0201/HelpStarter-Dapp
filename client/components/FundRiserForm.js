...
const FundRiserForm = () => {
  ...
  return (
    <div className='bg-[#EDF2F4] text-black'>
        ...
        <form onSubmit={(e)=>riseFund(e)}>
            ...
            <button className="p-2 w-full bg-[#EF233C] text-white rounded-md hover:bg-[#D80032]" disabled={btnLoading} >{btnLoading?"Loading...":"Rise fund"}</button>
        </form>
    </div>
  )
}
